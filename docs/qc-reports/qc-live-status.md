...
- **Closed (2026-04-22):** Narrow §8 on corrected Agent 3 intake vs repo — [`qc-verdict-agent-3-interview-negotiation-intake-document-corrected-2026-04-22.md`](./qc-verdict-agent-3-interview-negotiation-intake-document-corrected-2026-04-22.md). **No** implied **Approved For Integration** for legacy Interview or Negotiation **billing** from that document.  
...
- **2026-04-23 —** **Foundations — factual resync (pas A / dokumentacja; brak reassignment B/C):** Weryfikacja `cd /Users/nikodem/job-app-restore/proj/backend && npm test -- --run` → **31** plików testowych / **133** testy zielone. **Korekta:** starsze wpisy w *Last update* z **29 / 125** były **nieaktualne** — liczby zaktualizowane w tym samym pliku (bez zmiany treści §8 w plikach `qc-verdict-*.md`). **Binding:** cztery linie **Current valid statuses** — **linia 3** = werdykt dokumentu Agent 3 [`qc-verdict-agent-3-interview-negotiation-intake-document-corrected-2026-04-22.md`](./qc-verdict-agent-3-interview-negotiation-intake-document-corrected-2026-04-22.md) (**AFI** tylko dla poprawionego markdown §6; **NAFI** billingu legacy Interview / Negotiation). Coach + Live Interview billing — **AFI** bez poszerzenia (jak w kotwicach §8). **Live Interview:** w repo hermetyczny [`backend/src/trpc/routers/__tests__/liveInterview.router.spec.ts`](../../backend/src/trpc/routers/__tests__/liveInterview.router.spec.ts) oraz kompensacja `rejectSpend` (`pending_row_write_failed`) przy błędzie `UPDATE` pending po `approveSpend` — **nie** zmienia to samoczynnie treści tabeli integracji w [`qc-verdict-live-interview-billing-slice-2026-04-21.md`](./qc-verdict-live-interview-billing-slice-2026-04-21.md) (ew. **wąska delta QC**). **DDL MySQL na VPS** — nadal **OPS poza repo**. **Status pasu founds:** brak nowego własnego slice’a implementacyjnego w tym commicie — **waiting for PO reassignment** na dalszą pracę kodową.
...
- **Inteligencja modułów (B) — bounded AFI 2026-04-20:** [`qc-verdict-agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md`](./qc-verdict-agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md) + intak [`agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md`](./agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md) — tylko trzy nazwane tranche’e; backend **`npm test -- --run` → 133/133** (31 plików); otwarte: REST literal vs tRPC, brak pełnego Legal **`file_search`**, pełna spec Skill Lab / AI cost poza intakiem.
...
- **2026-04-20:** Werdykt bounded Agent 2 — [`qc-verdict-agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md`](./qc-verdict-agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md); intak §6 (resync): [`agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md`](./agent-2-delivery-intelligence-legal-skill-jobradar-2026-04-19.md). **133/133** testów backend (31 plików) w ostatniej weryfikacji `npm test -- --run`.
