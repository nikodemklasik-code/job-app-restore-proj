...
**PDF:** `Case_Practice_—_Game_Mechanics_Layer.pdf` from the same folder was **not** copied into git (binary); keep it in your asset vault or export again if needed; markdown above is the canonical text spec in-repo.
