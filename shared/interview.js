export const interviewModes = ['behavioral', 'technical', 'general', 'hr', 'case-study', 'language-check'];
export const interviewModeLabels = {
...
export const interviewDifficulties = ['standard', 'stretch', 'senior'];
