...
export function JobCardCompact({
    ...
    return (
        <article
            className={`
        group relative bg-slate-900/50 backdrop-blur-sm border rounded-2xl p-5 
        transition-all duration-300 cursor-pointer
        ${isExpanded
                    ? 'border-emerald-500/40 shadow-lg shadow-emerald-900/20 bg-slate-900/80'
            ...
            <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <button
                        ...
                        className="w-9 h-9 rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-700 border border-slate-700 transition-all flex items-center justify-center"
