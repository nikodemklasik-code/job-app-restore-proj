...
export const APP_SCREENS: Record<AppScreenKey, AppScreenDefinition> = {
  ...
  negotiation: { key: 'negotiation', label: 'Negotiations', path: '/negotiation', topLevel: true, showInSidebar: true },
  caseStudy: { key: 'caseStudy', label: 'Case Study', path: '/case-study', topLevel: true, showInSidebar: true },
