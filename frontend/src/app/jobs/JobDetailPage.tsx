...
export default function JobDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0B1121] text-slate-300">
            ...
            {/* Sticky Header */}
            <header className="sticky top-0 z-40 bg-[#0B1121]/80 backdrop-blur-xl border-b border-slate-800/80 px-8 py-5">
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-800 text-slate-300 hover:text-white hover:bg-slate-700 border border-slate-700 transition-all"
                        >
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
                            <div className="flex items-start gap-5 mb-6">
                                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center shrink-0 border border-slate-700 shadow-inner">
                            ...
                            <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(job.requirements as string[]).map((req, i) => (
                                        <span
                                            key={i}
                                            className="px-3 py-1.5 rounded-lg border border-slate-700 bg-slate-800/50 text-sm font-medium text-slate-300"
                                        >
                                            {req}
                                        </span>
                                    ))}
                    ...
                    <div className="space-y-6">
                        ...
                        <section className="bg-gradient-to-br from-slate-900 to-slate-900/50 border border-slate-800 rounded-2xl p-6">
                            ...
                            <div className="flex flex-col gap-3">
                                <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-slate-700 hover:bg-slate-600 text-white text-sm font-medium transition-colors border border-slate-600">
                                    <Sparkles className="w-4 h-4" />
                                    Tailor Resume
                                </button>
                                <Link
