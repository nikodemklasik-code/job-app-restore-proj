    ...
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-emerald-400/25 bg-emerald-500/10 p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-emerald-100">Empty state rule</h3>
            <p className="mt-1 text-sm text-emerald-50/90">
              If no posts, events, or highlights are available, show a clear prompt: invite one peer, join one event, and return here after
