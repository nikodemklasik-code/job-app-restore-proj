  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-400 ml-14">Full UK employment law destination: browse legal sections below or use Legal Search for source-restricted research.</p>
      </div>
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h2 id="legal-hub-search-heading" className="text-base font-semibold text-white">Legal Search</h2>
            <p className="mt-1 text-sm text-slate-300">
              Search approved UK employment law sources. Enter a topic or full legal question to receive a grounded summary with relevant ACAS, GOV.UK, and HMRC references.
            </p>
          </div>
        </div>
        ...
        {legalSearch.data && legalSearch.data.hits.length > 0 && !legalSearch.isError && (
          <div className="mt-4 rounded-xl border border-indigo-500/20 bg-indigo-950/20 p-3">
            ...
            {!includeGroundedSummary ? (
              ...
              >
                Summarise these official links (AI synthesis — catalogue only)
              </button>
            ) : null}
        ...
        {matchedSections.length > 0 && (
          <div className="mt-4 rounded-xl border border-white/10 bg-white/[0.03] p-3">
            ...
            <p className="mt-2 text-[11px] text-slate-500">
              Tip: Use Legal Search for source-backed orientation, then rely on the curated Legal Hub sections below as your stable reference baseline.
            </p>
          </div>
        )}
