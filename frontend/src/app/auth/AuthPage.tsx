...
function DeviceMockup() {
  ...
  // Sync muted state to video element (React attribute alone isn't enough after initial render)
  useEffect(() => {
          ...
          {embedUrl ? (
            ...
            <>
              ...
              <button
                ...
                className="absolute bottom-2 right-2 z-10 flex items-center justify-center rounded-full bg-black/50 p-1.5 text-white backdrop-blur-sm hover:bg-black/70 transition-colors"
