  ...
  return (
    <div className="mx-auto flex h-[calc(100dvh-6rem)] min-h-[760px] max-w-7xl flex-col gap-4 overflow-hidden px-1">
      <PracticeExperienceHeader
        ...
        title="Interview"
        description="Front-facing interviewer flow: realistic prompts, follow-up pressure, transcript continuity, and voice/text input. Camera support is reserved, not faked. Shocking restraint."
