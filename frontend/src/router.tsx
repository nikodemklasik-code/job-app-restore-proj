...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'practice/interview', element: withSuspense(InterviewPractice) },
      ...
      { path: 'practice/negotiation', element: withSuspense(NegotiationPage) },
      ...
      { path: 'practice/daily-warmup', element: withSuspense(DailyWarmupPage) },
      { path: 'practice/coach', element: withSuspense(CoachPage) },
      { path: 'faq', element: withSuspense(FAQPage) },
      { path: 'documents', element: withSuspense(DocumentLab) },
      { path: 'practice/case', element: withSuspense(CasePracticePage) },
      { path: 'interview', element: <Navigate to="/practice/interview" replace /> },
      { path: 'warmup', element: <Navigate to="/practice/daily-warmup" replace /> },
      { path: 'coach', element: <Navigate to="/practice/coach" replace /> },
      { path: 'negotiation', element: <Navigate to="/practice/negotiation" replace /> },
      { path: 'case-practice', element: <Navigate to="/practice/case" replace /> },
      { path: 'interview-warmup', element: <Navigate to="/practice/daily-warmup" replace /> },
      { path: 'negotiation-coach', element: <Navigate to="/practice/negotiation" replace /> },
    ],
  },
]);
